...
function dePalabrasAFrase(palabras) {
  ...
  // Tu código:
  var frase = "";
  while (typeof (i = palabras.shift()) !== 'undefined') {
    frase += i + " ";
  }
...
function agregarNumeros(numeros) {
  ...
  // Tu código:
  var suma = 0;
  while (typeof (i = numeros.shift()) !== 'undefined') {
    suma += i;
  }
  return suma;
}
...
function promedioResultadosTest(resultadosTest) {
  ...
  while (typeof (i = resultadosTest.shift()) !== 'undefined') {
    suma += i;
  }
  promedio = (suma / cantResultados);
  return promedio;
}
